...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ArtifactiValue) DeepCopyInto(out *ArtifactiValue) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ArtifactiValue.
func (in *ArtifactiValue) DeepCopy() *ArtifactiValue {
	if in == nil {
		return nil
	}
	out := new(ArtifactiValue)
	in.DeepCopyInto(out)
	return out
}
